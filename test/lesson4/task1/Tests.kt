...
class Tests {
    ...
    fun russian() {
        ...
        assertEquals("пятьсот восемьдесят четыре тысячи пятьсот восемьдесят", russian(584580))
        assertEquals("девятьсот двадцать тысяч", russian(920000))
        assertEquals("восемьдесят две тысячи двести девяносто", russian(82290))
    }
}